...
namespace Smart\Sage50\Invoice\InvoiceLookup;
...
class InvoiceLookupEntity
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="\Smart\Sage50\Invoice\InvoiceEntity", inversedBy="invoiceLookup")
    ...
    /**
     * @ORM\OneToMany(targetEntity="\Smart\Sage50\Invoice\InvoiceLookup\TotalTaxes\TotalTaxesEntity", mappedBy="invoiceLookup")
